...
|---|---|---|---|---|
| 2026-09-15 | task | open | [keepalive-quarantine-uncached-requests](./2026-09-15-keepalive-quarantine-uncached-requests.md) | cache に乗らなかった request を研究用に一定期間・一定量だけ退避する |
