...
|---|---|---|---|---|
| 2026-09-19 | bug | wip | [codex-route-rejects-image-tool-result](./2026-09-19-codex-route-rejects-image-tool-result.md) | codex 経路が画像を含む tool_result を拒否し route 全滅で 503 になる |
