...
|---|---|---|---|---|
| 2026-07-28 | design | wip | [cred-sharing-refresh-race-staleness](./2026-07-28-cred-sharing-refresh-race-staleness.md) | credential をプロセス間で共有する前提の残課題 (同時 refresh のレースと access token の陳腐化) |
