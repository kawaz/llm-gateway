...
|---|---|---|---|---|
| 2026-09-06 | request | open | [events-keepalive-until-and-pause-event](./2026-09-06-events-keepalive-until-and-pause-event.md) | request event に keepalive の終端 (keepalive_until) を載せ、pause 時に event を出す |
