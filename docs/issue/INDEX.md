...
| 2026-09-03 | request | wip | [check-warn-namespace-without-routing](./2026-09-03-check-warn-namespace-without-routing.md) | check/起動時に routing/alias が空の namespace を warning、check 出力に ns 要約行を追加 |
