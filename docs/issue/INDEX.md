...
| 2026-09-07 | bug | wip | [discovery-codex-client-version](./2026-09-07-discovery-codex-client-version.md) | codex 経路の discovery が gateway 自身の版を client_version に送り catalog が常に空 |
