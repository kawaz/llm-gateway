...
|---|---|---|---|---|
| 2026-09-08 | bug | open | [openai-cached-tokens-double-count](./2026-09-08-openai-cached-tokens-double-count.md) | OpenAI の usage で cached_tokens が input_tokens に含まれるのに二重課金している (gpt 系の USD… |
...
| 2026-09-07 | bug | open | [discovery-codex-client-version](./2026-09-07-discovery-codex-client-version.md) | codex 経路の discovery が gateway 自身の版を client_version に送り catalog が常に空 |
