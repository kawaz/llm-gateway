...
| 2026-09-07 | request | wip | [models-endpoint-codex-shape](./2026-09-07-models-endpoint-codex-shape.md) | codex CLI 向けに GET /{ns}/v1/models を ChatGPT backend の形 ({models:[…]}) で返す |
