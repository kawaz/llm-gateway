...
|---|---|---|---|---|
| 2026-09-08 | bug | open | [keepalive-foreign-standby-regenerates-horizon](./2026-09-08-keepalive-foreign-standby-regenerates-horizon.md) | 二重 gateway の keepalive 引き継ぎ (Foreign → standby) が horizon を再生成する |
